...
def transform_data(sqlContext, user_sessions_chunk_df, product_attributes):
    """Transforms event data before inserting into Cassandra table."""
...
def insert_records(session, user_sessions_df, prepared_sessions):
    """Inserts dataframe into Cassandra table."""
...
def main():
    """Executes Batch pipeline to store dataset into Cassandra table."""
    ...
    user_sessions_chunks_df = pd.read_csv(
        args.input, encoding='utf-8', chunksize=int(10**5))
